...
public class IntakeControlRollers extends Command {
    ...
    Robot.intake.intakeFeeding(Robot.oi.getManipulatorTriggerLeft(), RollerDirection.INTAKE);
    Robot.intake.intakeRightLeft(Robot.oi.getManipulatorTriggerLeft(), RollerDirection.INTAKE);
    Robot.intake.intakeParallelBand(Robot.oi.getManipulatorTriggerLeft(), RollerDirection.INTAKE);
