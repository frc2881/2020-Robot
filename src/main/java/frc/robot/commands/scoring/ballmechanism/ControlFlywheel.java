...
public class ControlFlywheel extends Command {
    ...
    protected void execute() {
        if (Robot.flywheel.getFlywheelRPM() > 4000 && speed == 0.85) {
            Robot.flywheel.flywheelReady = true;
            if (Robot.flywheel.getFlywheelRPM() > 4400) {
                speed = 0.5;
                overLimit = true;
            }
        } else if (overLimit && Robot.flywheel.getFlywheelRPM() < 4300) {
            overLimit = false;
            speed = 0.85;
        }
