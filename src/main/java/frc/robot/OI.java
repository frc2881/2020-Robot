...
public class OI {
    ...
    public OI() {
        ...
        manipulatorPOV90 = buttonFromPOV(manipulator, 0);
        manipulatorPOV90.whileHeld(new ArmToAngle(40));

        manipulatorPOV180 = buttonFromPOV(manipulator, 0);
        manipulatorPOV180.whileHeld(new ArmToAngle(0));

        manipulatorPOV270 = buttonFromPOV(manipulator, 0);
        manipulatorPOV270.whileHeld(new ArmToAngle(20));
