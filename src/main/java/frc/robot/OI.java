...
public class OI {
    ...
    public OI() {
        ...
        driverBlueX.whileHeld(new IntakeSetAsBack());

        driverGreenTriangle = new JoystickButton(driver, 1);
        driverGreenTriangle.whileHeld(new IntakeSetAsFront());

        // MANIPULATOR
        manipulatorPinkSquare = new JoystickButton(manipulator, 1); // want to be Intake
        manipulatorPinkSquare.whileHeld(new ArmAligningControl(true));
        ...
        manipulatorRedCircle.whileHeld(new ArmAligningControl(false));
