...
public class OI {
    ...
    public OI() {
        ...
        manipulatorPinkSquare.whileHeld(new TurnToAngle(270));

        manipulatorBlueX = new JoystickButton(manipulator, 2);
        manipulatorBlueX.whenPressed(new IntakeSetAsBack());

        manipulatorRedCircle = new JoystickButton(manipulator, 3);
        manipulatorRedCircle.whileHeld(new TurnToAngle(90));

        manipulatorGreenTriangle = new JoystickButton(manipulator, 4);
        manipulatorGreenTriangle.whenPressed(new IntakeSetAsFront());
    }
