...
public class Robot extends TimedRobot {
    ...
    private ComplexWidget position = Shuffleboard.getTab("Driver Station")
        .add("Autonomous Options", startingPosition)
        .withWidget(BuiltInWidgets.kComboBoxChooser);
    private SendableChooser<AutoOptions> autoOptions = new SendableChooser<>();
    private ComplexWidget options = Shuffleboard.getTab("Driver Station")
        .add("Autonomous Options", autoOptions)
        .withWidget(BuiltInWidgets.kComboBoxChooser);
    ...
    public void robotInit() {
        ...
        chooser.setDefaultOption("Drive Forward", DriveForward::new); // for subsequent options call "addObject"
        chooser.addOption("Autonomous Command", () -> new AutoCommand(autoOptions.getSelected(), startingPosition.getSelected(),
    ...
    public void autonomousInit() {
        autonomousCommand = chooser.getSelected().get();
