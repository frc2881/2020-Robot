...
import frc.robot.utils.frc4048.Logging.Subsystems;
...
public class BallStorage extends Subsystem {
    ...
    public Logging.LoggingContext loggingContext = new Logging.LoggingContext(Logging.Subsystems.BALLSTORAGE){
        ...
        protected void addAll(){
            add("Left alinging REV", intakeLeft.getBusVoltage());
            add("Left aligning REV", intakeLeft.getOutputCurrent());
            add("Left aligning REV", intakeLeft.getStickyFaults());
            add("Right aligning REV", intakeRight.getBusVoltage());
            add("Right aligning REV", intakeRight.getOutputCurrent());
            add("Right aligning REV", intakeRight.getStickyFaults());
        }
    };
