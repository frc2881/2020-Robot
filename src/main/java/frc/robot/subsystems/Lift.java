...
public class Lift extends Subsystem {
    ...
    public void initSendable(SendableBuilder builder) {
        ...
        builder.addDoubleProperty("Climber 1 Bus Voltage", () -> liftMotor.getBusVoltage(), null);
        builder.addDoubleProperty("Climber 1 Output Current", () -> liftMotor.getOutputCurrent(), null);
        builder.addDoubleProperty("Climber 1 Sticky Faults", () -> liftMotor.getStickyFaults(), null);

        builder.addDoubleProperty("Climber 2 Bus Voltage", () -> liftMotor2.getBusVoltage(), null);
        builder.addDoubleProperty("Climber 2 Output Current", () -> liftMotor2.getOutputCurrent(), null);
        builder.addDoubleProperty("Climber 2 Sticky Faults", () -> liftMotor2.getStickyFaults(), null);
    }
