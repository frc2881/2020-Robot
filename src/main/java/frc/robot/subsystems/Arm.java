...
public class Arm extends Subsystem {
    ...
    public Arm() {
        ...
        armEncoder.setPositionConversionFactor(distancePerPulse);
        armEncoder.setPosition(2.0012);
        armPosition = () -> armEncoder.getPosition();// - beginningPosition;
    ...
    public double getArmPosition() {
        if (armPosition.getAsDouble() < 2.0012) {
            armEncoder.setPosition(2.0012);
        } 
        return armPosition.getAsDouble();
    }
