...
public class Arm extends Subsystem {
    ...
    private ArmAmpMonitor ampMonitor;
    ...
    public Arm() {
        ...
        ampMonitor = new ArmAmpMonitor(25, 5, () -> armMotor.getOutputCurrent(), () -> armEncoder.getVelocity());
    ...
    public void initSendable(SendableBuilder builder) {
        ...
        builder.addBooleanProperty("Is Current Spiked", this::isCurrentSpiked, null);
    }
    ...
    public boolean armGoingUp() {
        return ampMonitor.armGoingUp();
    }

    public double getArmPosition() {
        if ((armPosition.getAsDouble() - beginningPosition < 2.0012) || (!armGoingUp() && isCurrentSpiked())) {
