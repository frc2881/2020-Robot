...
public class Arm extends Subsystem {
    ...
    public static final double towerAngle = 34;
    public static final double backBumperAngle = 4.68 + 1;
    public static final double frontBumperAngle = 1;
    ...
    public void resetArmEncoder(boolean autonomous) {
        beginningPosition = autonomous ? -10.1388 : armPosition.getAsDouble();
