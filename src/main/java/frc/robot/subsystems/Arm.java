...
public class Arm extends Subsystem {
    ...
    private static final double highestGearTeethNumber = 72;
    ...
    private DoubleSupplier armVelocity;
    private DoubleSupplier armCurrent;
    private DoubleSupplier pdpCurrent;
    ...
    public Arm() {
        ...
        armCurrent = () -> armMotor.getOutputCurrent();

        pdp = new PowerDistributionPanel(20);
        pdpCurrent =() -> pdp.getCurrent(4);
        ...
        armPosition = () -> armEncoder.getPosition() * distancePerPulse;
        armVelocity = () -> armEncoder.getVelocity() * distancePerPulse;
    ...
    public double getArmVelocity() {
        return armVelocity.getAsDouble();
    }

    public double getArmCurrent() {
        return armCurrent.getAsDouble();
    }

    public double getPdpCurrent() {
        return pdpCurrent.getAsDouble();
    }
