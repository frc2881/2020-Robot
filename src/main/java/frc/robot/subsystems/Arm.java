...
public class Arm extends Subsystem {
    ...
    private static final double highestGearTeethNumber = 0;//TODO ask Anna Bown about these
    private static final double lowestGearTeethNumber = 0;
    private static final double encoderCountsPerRevolution = 42;
    private static final double wheelDiameter = 0;
    ...
    public Arm() {
        ...
        beginningPosition = armEncoder.getPosition() * distancePerPulse;
