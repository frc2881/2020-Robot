...
public class Intake extends Subsystem {
    ...
    public boolean feederStop = false;
    ...
    public void initSendable(SendableBuilder builder) {
        ...
        builder.addDoubleProperty("Intake Bus Voltage", () -> feeder.getBusVoltage(), null);
        builder.addDoubleProperty("Intake Output Current", () -> feeder.getOutputCurrent(), null);
        builder.addDoubleProperty("Intake Sticky Faults", () -> feeder.getStickyFaults(), null);
    }
