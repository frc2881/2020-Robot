...
public class Intake extends Subsystem {
    ...
    public Intake() {
        ...
        flywheel = new CANSparkMax(6, MotorType.kBrushless); // Flywheel

        flywheel.restoreFactoryDefaults();
        flywheel.setInverted(false);
        flywheel.setIdleMode(IdleMode.kCoast); // Agreed to keep it in coast mode
        ...
        intakeMain = new CANSparkMax(10, MotorType.kBrushless); // Tube Intake
