...
private CANSparkMax intakeParallel;
...
intakeRollers = new CANSparkMax(0, MotorType.kBrushless);

intakeRollers.restoreFactoryDefaults();
intakeRollers.setInverted(false);
intakeRollers.setIdleMode(IdleMode.kCoast);
//what does kCoast mean?

intakeParallel = new CANSparkMax(0, MotorType.kBrushless);

intakeParallel.restoreFactoryDefaults();
intakeParallel.setInverted(false);
intakeParallel.setIdleMode(IdleMode.kCoast);
    ...
    public void intakeRollIn(double speed, RollerDirection state){
    ...
    public boolean getIntakeRollIn(){
        return (intakeRollers.get() > 0.05);
